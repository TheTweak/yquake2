...
extern bool LoadSTB(const char *origname, const char* type, byte **pic, int *width, int *height);
extern bool ResizeSTB(byte *input_pixels, int input_width, int input_height,
